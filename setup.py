#!/usr/bin/env python
"""
Package metadata for getsmarter-api-clients.
"""
import os
import re
import sys
...
VERSION = get_version('get_smarter_api_clients', '__init__.py')
...
setup(
    ...
    url='https://github.com/edx/getsmarter-api-clients',
    packages=[
        'get_smarter_api_clients',
    ],
