...
"""
getsmarter-api-clients documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'getsmarter-api-clients',  # Repo name
...
#
# html_title = 'getsmarter-api-clients v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'Clients to interact with GetSmarter APIs.',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'get_smarter_api_clients'),
                os.path.join(root_path, 'get_smarter_api_clients/migrations')])
