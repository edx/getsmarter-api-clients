...
VERSION = get_version('../getsmarter-api-clients', '__init__.py')
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'getsmarter-api-clients'),
                os.path.join(root_path, 'getsmarter-api-clients/migrations')])
